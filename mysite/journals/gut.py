...
class Gut(Journal):
    ...
    def get_paper_info(self, paper_url: str):
        ...
        authors = '; '.join([first+' '+last for first,last in zip(first_authors,last_authors)]) if len(first_authors) == len(last_authors) else '; '.join(last_authors)
